...
def Init():
    ...
    suelo = Suelo(".\Texturas\BaseSuelo.obj")
    suelo.generate()
    suelo2 = Suelo(".\Texturas\Suelo.obj")
    suelo2.generate()
    # Texturas para las vallas
    vallaC = Valla(".\Texturas\VallaChica1.obj")
    vallaC.generate()
    vallaL1 = Valla(".\Texturas\VallaLarga1.obj")
    vallaL1.generate()
    vallaL2 = Valla(".\Texturas\VallaLarga2.obj")
    vallaL2.generate()
    vallaL3 = Valla(".\Texturas\VallaLarga3.obj")
    vallaL3.generate()
    vallaM1 = Valla(".\Texturas\VallaMediana1.obj")
    vallaM1.generate()
    vallaM2 = Valla(".\Texturas\VallaMediana2.obj")
    vallaM2.generate()
    
    # Arreglo de la direccion de las texturas de las personas
    obj_files = [".\Texturas\persona.obj"]
    # Casa verde y amarilla
    casa = Casa(".\Texturas\CasaVerde.obj")
    casa.generate()
    casa2 = Casa(".\Texturas\CasaAmarilla.obj")
    casa2.generate()
    # Creamos el bus
    bus = Vehiculo(".\Texturas\BusAmarillo.obj")
    bus.generate()
    carro = Vehiculo(".\Texturas\Chevrolet_Camaro_SS_Low.obj")
    # Creamos el letrero
    letrero = Letrero(".\Texturas\Letrero.obj")
    letrero.generate()
    
    #asignamos las texturas a los faros
    lampara = Lampara(".\Texturas\Faros.obj")
    lampara.generate()
    #asignamos las texturas a cada objeto dentro de la casa
    alfombra = Decoracion(".\Texturas\Alfombra.obj")
    alfombra.generate()
    amongus = Decoracion(".\Texturas\Amongus.obj")
    amongus.generate()
    cama = Decoracion(".\Texturas\Cama.obj")
    cama.generate()
    closet = Decoracion(".\Texturas\Closet.obj")
    closet.generate()
    cocinaLavabo = Decoracion(".\Texturas\CocinaLavabo.obj")
    cocinaLavabo.generate()
    foco = Decoracion(".\Texturas\\foco.obj")
    foco.generate()
    mesaySillas = Decoracion(".\Texturas\MesaySillas.obj")
    mesaySillas.generate()
    muebleIndividual = Decoracion(".\Texturas\MuebleIndividual.obj")
    muebleIndividual.generate()
    muebleMediano = Decoracion(".\Texturas\MuebleMediano.obj")
    muebleMediano.generate()
    muebleMedianoParaTele = Decoracion(".\Texturas\MuebleMedianoParaTele.obj")
    muebleMedianoParaTele.generate()
    muebleParaTele = Decoracion(".\Texturas\MuebleParaTele.obj")
    muebleParaTele.generate()
    sillonGrande = Decoracion(".\Texturas\SillonGrande.obj")
    sillonGrande.generate()
    sillonIndividual = Decoracion(".\Texturas\SillonIndividual.obj")
    sillonIndividual.generate()
    
    # Texturas para el fondo
    fondo = Fondo([".\Fondo\FondoDesierto.bmp"])
    fondo2 = Fondo([".\Fondo\FondoDesierto.bmp"])
    fondo3 = Fondo([".\Fondo\FondoDesierto.bmp"])
    fondo4 = Fondo([".\Fondo\FondoDesierto.bmp"])
    fondo5 = Fondo([".\Fondo\\NubesDesenfocadas2.bmp"])
